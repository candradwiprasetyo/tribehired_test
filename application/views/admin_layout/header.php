...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?= ucwords($data_head['title']) ?> | Administrator 8bulbs</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
           ...
           <div style="font-weight:bold; text-align:center;">8bulbs</div>
               <div style="font-size:12px; font-weight:bold; color:#ccc; text-align:center">One-stop platform for hiring creative arts talent in Indonesia</div>
